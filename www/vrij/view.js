class VrijView {
  ...
  showTasklist(div, title, tasks) {
    ...
    /* body */
    html +=
      "<div class='ui-resize ui-content' data-role='content' data-theme='a'>" +
      "<h3 class='details'>" +
      title +
      "</h3>";
    ...
    html +=
      ...
      "<table id='' data-role='table' class='ui-responsive ui-table ui-table-reflow'>" +
      "<tbody id='title'>" +
      "<tr>" +
      "<td><b>Datum</b></td>" +
